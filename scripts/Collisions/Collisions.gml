...
function check_collision(_move_x, _move_y) 
{
	...
	var _mid_bottom = tilemap_get_at_pixel(obj_game_manager.collision_tilemap, (bbox_left+bbox_right)/2 + _move_x, bbox_bottom + _move_y);
	var _mid_top = tilemap_get_at_pixel(obj_game_manager.collision_tilemap, (bbox_left+bbox_right)/2 + _move_x, bbox_top + _move_y);
	...
	if (_left_top or _right_top or _right_bottom or _left_bottom or _mid_bottom)
	{
		return true;
	}
